...
impl InteractiveBuilder {
    ...
    pub fn build_query(&self) -> RhemaResult<String> {
        ...
        let query = match choice.as_str() {
            ...
            _ => return Err(crate::error::RhemaError::InvalidCommand("Invalid choice".to_string())),
        };
    ...
    fn prompt_input(&self, prompt: &str) -> RhemaResult<String> {
        ...
        if input.is_empty() {
            return Err(crate::error::RhemaError::InvalidCommand(format!("{} cannot be empty", prompt)));
        }
    ...
    fn prompt_priority(&self) -> RhemaResult<String> {
        ...
        Ok(match choice.as_str() {
            ...
            _ => return Err(crate::error::RhemaError::InvalidCommand("Invalid priority".to_string())),
        })
    }
    ...
    fn prompt_confidence(&self) -> RhemaResult<u8> {
        ...
        choice.parse::<u8>()
            .map_err(|_| crate::error::RhemaError::InvalidCommand("Invalid confidence level".to_string()))
    }
    ...
    fn prompt_usage(&self) -> RhemaResult<String> {
        ...
        Ok(match choice.as_str() {
            ...
            _ => return Err(crate::error::RhemaError::InvalidCommand("Invalid usage".to_string())),
        })
    }
    ...
    fn prompt_effectiveness(&self) -> RhemaResult<u8> {
        ...
        choice.parse::<u8>()
            .map_err(|_| crate::error::RhemaError::InvalidCommand("Invalid effectiveness level".to_string()))
    }
    ...
    fn prompt_status(&self) -> RhemaResult<String> {
        ...
        Ok(match choice.as_str() {
            ...
            _ => return Err(crate::error::RhemaError::InvalidCommand("Invalid status".to_string())),
        })
    }
    ...
    fn prompt_format(&self) -> RhemaResult<String> {
        ...
        Ok(match choice.as_str() {
            ...
            "3" => "table".to_string(),
            "4" => "count".to_string(),
            _ => return Err(crate::error::RhemaError::InvalidCommand("Invalid format".to_string())),
        })
    }
