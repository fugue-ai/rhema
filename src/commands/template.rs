...
use crate::commands::{load_template_library, save_template_library, load_template_export, save_template_export, load_prompts};
use clap::Subcommand;
...
fn import_templates(
    ...
    if let Some(library_name) = library {
        ...
        crate::commands::save_prompts(&prompts_path, &prompts)?;
