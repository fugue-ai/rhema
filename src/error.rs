...
impl From<crate::config::ConfigError> for RhemaError {
...
impl From<crate::agent::state::AgentError> for RhemaError {
    fn from(err: crate::agent::state::AgentError) -> Self {
        RhemaError::AgentError(err.to_string())
    }
}

impl From<crate::agent::locks::LockError> for RhemaError {
    fn from(err: crate::agent::locks::LockError) -> Self {
        RhemaError::LockError(err.to_string())
    }
}

impl From<crate::agent::coordination::SyncError> for RhemaError {
    fn from(err: crate::agent::coordination::SyncError) -> Self {
        RhemaError::CoordinationError(err.to_string())
    }
}

impl From<crate::safety::SafetyViolation> for RhemaError {
    fn from(err: crate::safety::SafetyViolation) -> Self {
        RhemaError::SafetyViolation(err.to_string())
    }
} 