...
use super::{Config, ConfigError, ConfigIssue, ConfigIssueSeverity};
                        ...
                        if let Some(credentials) = git.get("credentials") {
                            ...
                            if !has_username && !has_email && !has_ssh_key && !has_token {
                                issues.push(ConfigIssue {
                                    ...
                                    path: None,
                                    field: Some("integrations.git.credentials".to_string()),
                        ...
                        if let Some(path_str) = path_value.as_str() {
                            ...
                            if !path.exists() {
                                issues.push(ConfigIssue {
                                    ...
                                    path: None,
                                    field: Some(format!("environment.paths.{}", field)),
