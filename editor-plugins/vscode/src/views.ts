...
export class RhemaViews {
    ...
    async initialize(context: vscode.ExtensionContext): Promise<void> {
        try {
            ...
            const insightsView = vscode.window.registerTreeDataProvider('rhemaInsights', insightsProvider);
            const patternsView = vscode.window.registerTreeDataProvider('rhemaPatterns', patternsProvider);
            const decisionsView = vscode.window.registerTreeDataProvider('rhemaDecisions', decisionsProvider);
...
class RhemaScopesProvider implements vscode.TreeDataProvider<RhemaTreeItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<RhemaTreeItem | undefined | null | void> = new vscode.EventEmitter<RhemaTreeItem | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<RhemaTreeItem | undefined | null | void> = this._onDidChangeTreeData.event;
