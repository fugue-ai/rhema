...
class MockDocument {
    ...
    getWordRangeAtPosition(position) {
        ...
        if (wordMatch && position.character >= wordMatch.index && 
...
class MockSettings {
    getExecutablePath() { return 'rhema'; }
    isEnabled() { return true; }
    isAutoValidateEnabled() { return true; }
    isPerformanceProfilingEnabled() { return false; }
...
class ProviderTestRunner {
    ...
    async testReferenceProvider() {
        ...
        try {
            ...
            const wordRange = document.getWordRangeAtPosition(position);
            if (wordRange) {
                const word = document.getText().substring(
