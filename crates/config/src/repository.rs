...
use crate::{ConfigAuditLog, ConfigHealth, ConfigStats, CURRENT_CONFIG_VERSION, Config};
...
impl Default for CommitConventions {
    fn default() -> Self {
        Self {
            ...
            types: vec!["feat".to_string(), "fix".to_string(), "docs".to_string(), "style".to_string(), "refactor".to_string(), "test".to_string(), "chore".to_string()],
            scopes: Vec::new(),
...
impl Default for CodeReviewConfig {
    fn default() -> Self {
        Self {
            ...
            guidelines: vec!["Check for security issues".to_string(), "Verify test coverage".to_string()],
            checklist: vec!["Code follows style guidelines".to_string(), "Tests pass".to_string()],
            timeout_hours: 72,
        }
    }
}
