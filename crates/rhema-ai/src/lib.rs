...
pub use advanced_features::{
    AdvancedFeaturesConfig, AdvancedFeaturesManager, PerformanceAlert, PerformanceMetric,
};
pub use agent::conflict_prevention::{
    Conflict, ConflictPreventionSystem, ConflictResolution, ConflictSeverity, ConflictStatus,
    ConflictType, ResolutionStrategy,
};
pub use agent::constraint_system::{
    Constraint, ConstraintContext, ConstraintSeverity, ConstraintSystem, ConstraintType,
...
impl From<agent::patterns::PatternError> for rhema_core::RhemaError {
    fn from(err: agent::patterns::PatternError) -> Self {
        match err {
            agent::patterns::PatternError::ValidationError(msg) => {
                rhema_core::RhemaError::ValidationError(msg)
            }
            agent::patterns::PatternError::ExecutionError(msg) => {
                rhema_core::RhemaError::SystemError(msg)
            }
            agent::patterns::PatternError::ResourceNotAvailable(msg) => {
                rhema_core::RhemaError::SystemError(msg)
            }
            agent::patterns::PatternError::AgentNotAvailable(msg) => {
                rhema_core::RhemaError::AgentError(msg)
            }
            agent::patterns::PatternError::PatternTimeout(msg) => {
                rhema_core::RhemaError::PerformanceError(msg)
            }
            agent::patterns::PatternError::RollbackError(msg) => {
                rhema_core::RhemaError::SystemError(msg)
            }
            agent::patterns::PatternError::InvalidState(msg) => {
                rhema_core::RhemaError::ValidationError(msg)
            }
            agent::patterns::PatternError::ConfigurationError(msg) => {
                rhema_core::RhemaError::ConfigError(msg)
            }
            agent::patterns::PatternError::CommunicationError(msg) => {
                rhema_core::RhemaError::NetworkError(msg)
            }
            agent::patterns::PatternError::ConstraintViolation(msg) => {
                rhema_core::RhemaError::ConstraintError(msg)
            }
            agent::patterns::PatternError::TemplateNotFound(msg) => {
                rhema_core::RhemaError::NotFound(msg)
            }
            agent::patterns::PatternError::PatternNotFound(msg) => {
                rhema_core::RhemaError::NotFound(msg)
            }
        }
    }
...
impl AgenticDevelopmentService {
    ...
    pub async fn new_with_syneidesis(
        ...
        let coordination_integration =
            CoordinationIntegration::new(service.coordination_system.clone(), syneidesis_config)
                .await?;
    ...
    pub async fn register_agent(
        &self,
        agent_info: agent::real_time_coordination::AgentInfo,
    ) -> rhema_core::RhemaResult<()> {
    ...
    pub async fn enforce_constraints(
        ...
        self.constraint_system
            .enforce_constraints(scope, context)
            .await
    }
    ...
    pub async fn detect_conflicts(
        &mut self,
    ) -> rhema_core::RhemaResult<Vec<agent::conflict_prevention::Conflict>> {
    ...
    pub async fn resolve_conflict(
        ...
        self.conflict_prevention_system
    ...
    pub async fn send_message(
        &self,
        message: agent::real_time_coordination::AgentMessage,
    ) -> rhema_core::RhemaResult<()> {
    ...
    pub fn get_lock_context(
        &self,
    ) -> rhema_core::RhemaResult<agent::lock_context::LockFileAIContext> {
    ...
    pub async fn register_agent_with_syneidesis(
        &self,
        agent_info: agent::real_time_coordination::AgentInfo,
    ) -> rhema_core::RhemaResult<()> {
    ...
    pub async fn send_message_with_syneidesis(
        &self,
        message: agent::real_time_coordination::AgentMessage,
    ) -> rhema_core::RhemaResult<()> {
...
mod tests {
    ...
    async fn test_agentic_development_service_creation() {
        ...
        assert_eq!(
            service.sync_coordinator.get_sync_statistics().total_scopes,
            0
        );
    }
