...
impl ToolRegistry {
    ...
    async fn register_builtin_tools(&self) -> ActionResult<()> {
        ...
        self.register_transformation_tool("jscodeshift", Box::new(JscodeshiftTool))
            .await;
        self.register_transformation_tool("comby", Box::new(CombyTool))
            .await;
        self.register_transformation_tool("ast-grep", Box::new(AstGrepTool))
            .await;
        self.register_transformation_tool("prettier", Box::new(PrettierTool))
            .await;
        ...
        self.register_validation_tool("typescript", Box::new(TypeScriptTool))
            .await;
        self.register_validation_tool("jest", Box::new(JestTool))
            .await;
        self.register_validation_tool("mocha", Box::new(MochaTool))
            .await;
    ...
    pub async fn register_transformation_tool(
        &self,
        name: &str,
    ...
    pub async fn execute_safety_check(
        &self,
        tool_name: &str,
        intent: &ActionIntent,
    ) -> ActionResult<ToolResult> {
