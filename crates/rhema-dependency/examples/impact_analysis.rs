...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        ...
        rds_impact.business_impact_score
    );
    println!("  Risk Level: {:?}", rds_impact.risk_level);
    println!(
        "  Affected Services: {}",
        rds_impact.affected_services.len()
    );
    ...
    println!(
        "  Business Impact Score: {:.2}",
        stripe_impact.business_impact_score
    );
    println!("  Risk Level: {:?}", stripe_impact.risk_level);
    println!(
        "  Affected Services: {}",
        stripe_impact.affected_services.len()
    );
    println!(
        "  Estimated Downtime: {:?}",
        stripe_impact.estimated_downtime
    );
    ...
    println!(
        "  Business Impact Score: {:.2}",
        user_service_impact.business_impact_score
    );
    println!("  Risk Level: {:?}", user_service_impact.risk_level);
    println!(
        "  Affected Services: {}",
        user_service_impact.affected_services.len()
    );
    println!(
        "  Estimated Downtime: {:?}",
        user_service_impact.estimated_downtime
    );
    ...
    println!(
        "  Business Impact Score: {:.2}",
        vpc_impact.business_impact_score
    );
    println!("  Risk Level: {:?}", vpc_impact.risk_level);
    println!(
        "  Affected Services: {}",
        vpc_impact.affected_services.len()
    );
    ...
    println!(
        "  Business Impact Score: {:.2}",
        change_impact.business_impact_score
    );
    println!("  Risk Level: {:?}", change_impact.risk_level);
    println!(
        "  Affected Services: {}",
        change_impact.affected_services.len()
    );
    println!(
    ...
    println!(
        "  Average Dependencies per Service: {:.2}",
    ...
    println!(
        ...
        health_report.critical_dependencies.len()
    );
