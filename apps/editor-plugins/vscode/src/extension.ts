...
export class RhemaExtension {
  ...
  private async registerCommands(): Promise<void> {
    ...
    const commandRegistrations = [
      ...
      vscode.commands.registerCommand('rhema.manageDecisions', () =>
        this.commands.manageDecisions()
      ),
      vscode.commands.registerCommand('rhema.showDependencies', () =>
        this.commands.showDependencies()
      ),
      ...
      vscode.commands.registerCommand('rhema.profilePerformance', () =>
        this.commands.profilePerformance()
      ),
      vscode.commands.registerCommand('rhema.refactorContext', () =>
        this.commands.refactorContext()
      ),
      vscode.commands.registerCommand('rhema.generateCode', () => this.commands.generateCode()),
      vscode.commands.registerCommand('rhema.showDocumentation', () =>
        this.commands.showDocumentation()
      ),
      vscode.commands.registerCommand('rhema.configureSettings', () =>
        this.commands.configureSettings()
      ),
      vscode.commands.registerCommand('rhema.runProviderTests', () =>
        this.commands.runProviderTests()
      ),
    ];
  ...
  private async registerProviders(): Promise<void> {
    ...
    const validationRegistration = vscode.languages.createDiagnosticCollection('rhema');
