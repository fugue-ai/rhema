...
fn setup_test_automation_with_config(
    config: rhema_git::git::automation::AutomationConfig,
...
fn test_schedule_validation() {
    ...
    config
        .git_workflow_integration
        .intervals
        .workflow_validation_interval = 0;
...
fn test_custom_configuration() {
    ...
    config
        .git_workflow_integration
        .intervals
        .feature_automation_interval = 600;
    config
        .git_workflow_integration
        .intervals
        .release_automation_interval = 7200;
    config
        .git_workflow_integration
        .intervals
        .hotfix_automation_interval = 900;
    config
        .git_workflow_integration
        .intervals
        .workflow_validation_interval = 1800;
